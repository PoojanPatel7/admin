...
// Handle form submission to insert data into multimedia
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $insert_query = "
        INSERT INTO multimedia (fm_radio, stereo_speakers, loudspeaker, audio_jack, device_id)
        VALUES ('$fm_radio', '$stereo_speakers', '$loudspeaker', '$audio_jack', '$device_id')
    ";

    if ($conn->query($insert_query)) {
        $message = "Multimedia data added successfully!";
    } else {
...
// Check if device is selected for multimedia form
...
<head>
    ...
    <title>Device Selection and Multimedia</title>
    <style>
        body {
...
<body>
    ...
    <?php else: ?>
        <!-- Multimedia Form -->
        <h1>Enter Multimedia Features for <?= $device['model_name'] ?></h1>
        ...
        <form method="post">
            ...
            <input type="checkbox" name="stereo_speakers" id="stereo_speakers">

            <label for="loudspeaker">Loudspeaker:</label>
            <input type="checkbox" name="loudspeaker" id="loudspeaker">

            <label for="audio_jack">Audio Jack:</label>
            <input type="text" name="audio_jack" id="audio_jack">
