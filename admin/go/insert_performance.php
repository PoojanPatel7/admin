...
// Handle form submission to insert data into performance table
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $insert_query = "
        INSERT INTO performance (chipset, CPU, architecture, fabrication, graphics, RAM, RAM_type, device_id)
        VALUES ('$chipset', '$cpu', '$architecture', '$fabrication', '$graphics', '$ram', '$ram_type', '$device_id')
    ";
...
// Check if device is selected for performance form
...
<head>
    ...
    <title>Device Selection and Performance Data</title>
    <style>
        body {
...
<body>
    ...
    <?php else: ?>
        ...
        <h1>Enter Performance Data for <?= $device['model_name'] ?></h1>
        ...
        <form method="post">
            ...
            <input type="text" name="architecture" id="architecture" required>

            <label for="fabrication">Fabrication:</label>
            <input type="text" name="fabrication" id="fabrication" required>
            ...
            <input type="text" name="ram_type" id="ram_type" required>
