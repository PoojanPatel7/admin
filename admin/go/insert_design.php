...
// Handle form submission to insert data into design table
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $insert_query = "
        INSERT INTO design (height, width, thickness, weight, build_material, colours, waterproof, ruggedness, device_id)
        VALUES ('$height', '$width', '$thickness', '$weight', '$build_material', '$colours', '$waterproof', '$ruggedness', '$device_id')
    ";

    if ($conn->query($insert_query)) {
        $message = "Design data added successfully!";
    } else {
...
// Check if device is selected for design form
...
<head>
    ...
    <title>Device Selection and Design Data</title>
    <style>
        body {
...
<body>
    ...
    <?php else: ?>
        <!-- Design Data Form -->
        <h1>Enter Design Data for <?= $device['model_name'] ?></h1>
        ...
        <form method="post">
            ...
            <input type="text" name="thickness" id="thickness" required>

            <label for="weight">Weight:</label>
            <input type="text" name="weight" id="weight" required>

            <label for="build_material">Build Material:</label>
            <input type="text" name="build_material" id="build_material">

            <label for="colours">Colours:</label>
            <input type="text" name="colours" id="colours">

            <label for="waterproof">Waterproof:</label>
            <input type="checkbox" name="waterproof" id="waterproof" value="1">

            <label for="ruggedness">Ruggedness:</label>
            <input type="checkbox" name="ruggedness" id="ruggedness" value="1">
