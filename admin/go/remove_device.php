...
if (isset($_POST['delete'])) {
    ...
    $sql_delete = "DELETE FROM device WHERE device_id = ?";
...
$sql_count = "SELECT COUNT(*) FROM device";
...
<head>
    ...
    <title>Remove Device from Database</title>
    <style>
        /* General Styles */
        body {
...
<body>
    ...
    <h2>Remove Device from Database</h2>
    ...
    <form method="POST">
        ...
        <select name="device_id" id="device_id">
            <?php while($row = $result->fetch_assoc()): ?>
                <option value="<?= $row['device_id']; ?>"><?= $row['model_name']; ?> (<?= $row['brand']; ?>)</option>
            <?php endwhile; ?>
        </select>
